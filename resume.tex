...
\name{Gabriel}{Peter}
\position{Swiss-American{\enskip\cdotp\enskip}Software Engineer}
...
% \homepage{gabrielpeter.net}
% \github{gabriel-peter}
% \linkedin{gabriel-peter}
% \gitlab{gitlab-id}
